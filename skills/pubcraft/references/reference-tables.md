# Cross-platform reference tables

Use these tables for fast lookups during routing decisions. They summarize content already covered in the per-platform reference files; the per-platform sections remain authoritative on conflict.

## AI-content policy and community sentiment (April 2026)
